...
class MovieRepositoryImpl(
    ...
    override fun getMovieDetails(movieId: Int): Observable<MovieDetails> {
        return Observable.zip(networkMovieDataSource.getMovieTrailer(movieId),
        networkMovieDataSource.getMovieDetails(movieId),
        BiFunction<MovieTrailerResponse, MovieDetailsResponse, MovieDetails>() { t1, t2 ->
            movieMapper.mapMovieDetails(t1, t2)
        })
    }
}